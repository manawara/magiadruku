...
function hs() {
  if (Qn) {
    var e = Qn,
      n = Kn;
    if (((Kn = Qn = null), Bo(e), n)) for (e = 0; e < n.length; e++) Bo(n[e]);
  }
}
function ys(e, n) {
  return e(n);
...
function Fc(e, n, t, r, l, u, o, i, s) {
  ((St = !1), (Tr = null), Dc.apply(Ic, arguments));
}
...
var lt = {
  ...
  Xo = ge(el),
  tf = V({}, el, { dataTransfer: 0 }),
  rf = ge(tf),
  lf = V({}, Xt, { relatedTarget: 0 }),
  xl = ge(lf),
  uf = V({}, lt, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  of = ge(uf),
  sf = V({}, lt, {
...
var vf = V({}, Xt, {
  ...
  wf = ge(gf),
  kf = V({}, lt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Sf = ge(kf),
  Ef = V({}, el, {
    deltaX: function (e) {
...
function Vs(e) {
  if (e.propertyName === "value" && nl(It)) {
    var n = [];
    (Us(n, It, e, Ku(e)), ws(Tf, n));
  }
}
function Rf(e, n, t) {
  e === "focusin"
    ? (ni(), (Ct = n), (It = t), Ct.attachEvent("onpropertychange", Vs))
    : e === "focusout" && ni();
}
function Of(e) {
...
var wt =
  ...
  Vf = new Set("cancel close invalid load scroll toggle".split(" ").concat(wt));
function oi(e, n, t) {
...
function cd(e, n) {
  ...
  for (du = { focusedElem: e, selectionRange: t }, Mr = !1, S = n; S !== null; )
...
var zd = es.exports,
  Vi = zd;
((Hl.createRoot = Vi.createRoot), (Hl.hydrateRoot = Vi.hydrateRoot));
function Td() {
  return bi.jsx("div", {
    className: "text-2xl font-bold text-blue-600",
    children: "Hello from React + Tailwind + Vite!",
  });
}
const Ld = Hl.createRoot(document.getElementById("root"));
Ld.render(bi.jsx(Td, {}));
